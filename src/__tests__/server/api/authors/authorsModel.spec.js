...
describe('Authors Data Model Functions', () => {
  ...
  describe('addAuthor', () => {
    ...
    test('addAuthor: Missing Author Feast Date failure', async () => {
      const author = {
        name: 'Moses the Godseer',
        title: 'Prophet',
        born: '1689',
    ...
    test('addAuthor: Missing Author Feast Month failure', async () => {
      const author = {
        name: 'Moses the Godseer',
        title: 'Prophet',
        born: '1689',
    ...
    describe('updateAuthor', () => {
      ...
      describe('updateAuthor: Failures', () => {
        ...
        test('updateAuthor: Missing Author Feast Date', async () => {
          const author = {
            id: 2,
            name: 'Moishe',
            title: 'Prophet',
        ...
        test('updateAuthor: Missing Author Feast Month', async () => {
          const author = {
            id: 2,
            name: 'Moishe',
            title: 'Prophet',
