...
describe('Author Mutations', () => {
  describe('addAuthor Mutation', () => {
    ...
    test('addAuthor Mutation', async () => {
      ...
      expect(addAuthor.args.feastDate.type.toString()).toEqual('Int!');
      expect(addAuthor.args.feastMonth.type.toString()).toEqual('Int!');
    ...
    test('updateAuthor Mutation', async () => {
      ...
      expect(updateAuthor.args.feastDate.type.toString()).toEqual('Int!');
      expect(updateAuthor.args.feastMonth.type.toString()).toEqual('Int!');
