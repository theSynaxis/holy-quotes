...
describe('Seed Tests', () => {
  ...
  describe('Authors Seed', () => {
    test('Should Run Author Seed', async () => {
      ...
      expect(result[0].feast_date).toEqual(24);
      expect(result[0].feast_month).toEqual(8);
